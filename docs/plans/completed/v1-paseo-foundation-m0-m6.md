# Completed History: Meetless V1 Foundation, M0–M6, And New Design
...
UX authority moved from the former design-package path to
...
Completed through M6 and the new-design workstream. M7 moved to the active plan.
...
The project-owner directive dated 2026-08-23 makes `docs/product/experience.md` the
...
handoff artifact conflicts with `docs/product/experience.md`, the product
contract wins. The complete
...
- **code_changed_assumptions:** the accepted V1 implementation proves the
  ...
  new `docs/product/experience.md` supersedes prior presentation requirements when they
...
- **playback:** `docs/product/experience.md` wins over the handoff playbar. Do not add visible
...
- **stable_contract_refs:** `docs/product/experience.md`, supporting design handoff,
...
- **product_authority:** `docs/product/experience.md` remains the outcome and behavior
...
- [x] Implement and technically accept the `docs/product/experience.md`
  new-design workstream.
